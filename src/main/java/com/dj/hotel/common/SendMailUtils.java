...
public class SendMailUtils {
		// 发件人的中文昵称
		private static final String nickname = "csx";
		// 发件人邮箱
		private static final String username = "15703500211@163.com";
		// 发件人在邮箱服务器中的授权码
		private static final String password = "FJFXKPBAKQJLOSKC";
		// 邮件的发送协议
		...
		public static void main(String[] args) {
			// 收件人邮箱地址
			String to = "2423739241@qq.com";
			// 邮件的主题
			String subject = "Hello";
			// 邮件正文的文本内容
			String body = "<h1>World</h1>";
			// 封装邮件实体
			// 发送邮件
			SendMailUtils.sendEmail(to, subject, body);
		}
